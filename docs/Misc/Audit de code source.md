...
| **Architecture**   | Dossier d'Architecture Technique (DAT), schémas/diagrammes de flux                                                                | Découpage en composants, flux de données, frontières de confiance, dépendances tierces (bibliothèques, API externes), choix technologiques                                            |
| **Implémentation** | Normes de développement sécurisé                                                                                                  | Règles de développement sécurisé effectivement définies, prise en compte des risques propres au langage/framework utilisé                                                             |
| **Administration** | Guide d'exploitation, procédures de déploiement                                                                                   | Procédures de déploiement, gestion des secrets et de la configuration, comptes de service, procédures de configurations/durcissement                                                  |
| **Utilisation**    | Manuel utilisateur, documentation d'API (eg. Swagger)                                                                             | Cas d'usage prévus vs. fonctionnalités documentées, cohérence entre droits documentés et profils utilisateurs                                                                         |
| **Tests**          | Plan de tests, cahier de recette, rapports de tests (unitaires, intégration, SAST, DAST, UAT)                                     | Couverture des tests, existence de tests de sécurité dédiés, traitement des résultats des campagnes précédentes                                                                       |
